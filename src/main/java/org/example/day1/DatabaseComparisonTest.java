...
public class DatabaseComparisonTest {
    // Oracle 连接信息
    private static final String ORACLE_URL = "jdbc:oracle:thin:@//192.168.0.168:1521/xe";
    private static final String ORACLE_USER = "system";
    private static final String ORACLE_PASSWORD = new KeyStore().oracle_password;

    // Snowflake 连接信息
    private static final String SNOWFLAKE_URL = "jdbc:snowflake://dqxoosj-oc93584.snowflakecomputing.com/?db=MIGRATION_TRAINING&schema=PRACTICE&warehouse=COMPUTE_WH";
    private static final String SNOWFLAKE_USER = "AlkeneX";
    private static final String SNOWFLAKE_PASSWORD = new KeyStore().snowflake_password;
